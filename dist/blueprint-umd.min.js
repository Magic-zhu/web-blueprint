(function (global, factory) {
  ...
  class BluePrintEditor {
      ...
      init() {
          ...
          this.container.addEventListener('mousemove', (ev) => {
              ...
              if (this.currentEventType === exports.EditorEventType.LineBegin) {
                  ...
                  this.currentLine.update(this.currentLine._begin, new Point(ev.clientX - this._translateLast[0] - ox, ev.clientY - this._translateLast[1] - oy));
              }
          });
      ...
      getOffset() {
          this._transform.transformOrigin
              .replace(/px/g, '')
              .split(' ');
          const ox = 0;
          const oy = 0;
