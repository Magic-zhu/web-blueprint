  ...
  class Node extends BaseNode {
      ...
      serialize() {
          ...
          container.preNodeIds = this.preNodes.map((node, index) => {
              return `${node.nodeId}-node-${this.getSerilazationStringFromLine(this.preLines[index])}`;
          });
          container.nextNodeIds = this.nextNodes.map((node, index) => {
              return `${node.nodeId}-node-${this.getSerilazationStringFromLine(this.nextLines[index])}`;
          });
          container.inputParamsIds = this.inputPoints.map((param) => {
              var _a;
              return ((_a = param.linkedParam) === null || _a === void 0 ? void 0 : _a.uid) + '-' + 'param';
          });
      ...
      getSerilazationStringFromLine(line) {
  ...
  class BluePrintEditor {
      ...
      restore(data) {
          ...
          arr.forEach((element, index) => {
              ...
              element.nextNodeIds.forEach((item) => { });
      ...
      reconnectBySerializationString(item, index) {
          ...
          this.graph[index].connect(connectInfo, exports.ConnectPosition.BEGIN);
          this.graph[targetIndex].connect(connectInfo2, exports.ConnectPosition.END);
      }
  }
