(function (global, factory) {
  ...
  class Line {
      ...
      update(begin, end) {
          let cp;
          let path;
          if (this.beginNodeConnectType === exports.NodeConnectType.NEXT) {
  ...
  var LineType;
  (function (LineType) {
      LineType["NodeToNode"] = "nodeToNode";
      LineType["ParamToNode"] = "paramToNode";
      LineType["ParamToParam"] = "paramToParam";
  })(LineType || (LineType = {}));
  ...
  class BluePrintEditor {
      ...
      handleConnectPointClick(info) {
          ...
          if (!this.isLineBegin()) {
              ...
              t.beginNodeConnectType = info.isPre
                  ? exports.NodeConnectType.PRE
                  : exports.NodeConnectType.NEXT;
              this.currentLine = t;
              this.addLine(t);
          }
          else {
              if (this.beginType === BeginType.PROCESS) {
                  ...
                  this.beginParam.connect(this.currentLine, info.node, ConnectPosition.BEGIN);
      ...
      paramPointClickHandler(info) {
          ...
          if (this.currentEventType !== EditorEventType.LineBegin) {
              ...
              this.lineGraph.push(this.currentLine);
              this.beginParam.connect(this.currentLine, info.param, ConnectPosition.BEGIN);
      ...
      processPointClickHandler(info) {
          ...
          if (this.currentEventType !== EditorEventType.LineBegin) {
              ...
              t.beginNodeConnectType = exports.NodeConnectType.NEXT;
              this.currentLine = t;
              this.addLine(t);
          }
          else {
      ...
      restore(data) {
          ...
          arr.forEach((element, index) => {
              element.preNodeIds.forEach((item) => {
      ...
      getTypeFromSerializationString(serializationString) {
          return serializationString.split('-')[1];
      }
      getNodeIdFromSerializationString(serializationString) {
          return serializationString.split('-')[0];
      }
      getBeginPointFromSerializationString(serializationString) {
          const n = serializationString.split('-');
          return new Point(+n[3], +n[4]);
      }
      getEndPointFromSerializationString(serializationString) {
          const n = serializationString.split('-');
          return new Point(+n[5], +n[6]);
      }
      getIsBeginNodeFromSerializationString(serializationString) {
          return serializationString.split('-')[2] === 'false' ? false : true;
      }
      getLineTypeFromSerializationString(serializationString) {
          return serializationString.split('-')[7];
      }
      getParamIndexFromSerializationString(serializationString) {
          return serializationString.split('-')[8];
      }
      findTargetIndexByNodeId(nodeId) {
          return this.graph.findIndex((it) => it.nodeId === nodeId);
      }
      reconnectBySerializationString(item, index) {
          const type = this.getLineTypeFromSerializationString(item);
          if (type === LineType.ParamToNode) ;
          else {
              const targetIndex = this.findTargetIndexByNodeId(this.getNodeIdFromSerializationString(item));
              let line;
              if (this.getIsBeginNodeFromSerializationString(item)) {
                  line = new Line(this.getBeginPointFromSerializationString(item), this.getEndPointFromSerializationString(item));
              }
              else {
                  line = new Line(this.getEndPointFromSerializationString(item), this.getBeginPointFromSerializationString(item));
              }
              line.beginNodeConnectType = exports.NodeConnectType.PRE;
              line.endNodeConnectType = exports.NodeConnectType.NEXT;
              this.addLine(line);
              const connectInfo = {
                  pos: [],
  ...
  class Node extends BaseNode {
      ...
      serialize() {
          ...
          container.preNodeIds = this.preNodes.map((node, index) => {
              return `${node.nodeId}-node-${this.getSerializationStringFromLine(this.preLines[index])}`;
          });
          container.nextNodeIds = this.nextNodes.map((node, index) => {
              return `${node.nodeId}-node-${this.getSerializationStringFromLine(this.nextLines[index])}`;
          });
      ...
      getSerializationStringFromLine(line) {
  ...
  exports.BaseNode = BaseNode$1;
  exports.BluePrintEditor = BluePrintEditor;
  exports.FactoryMap = FactoryMap;
  exports.Line = Line;
  exports.Node = Node;
  exports.NodeFactory = NodeFactory;
  exports.NodeFactoryInstance = NodeFactoryInstance;
  exports.Point = Point;
