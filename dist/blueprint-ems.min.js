...
class BluePrintEditor {
    ...
    processPointClickHandler(info) {
        ...
        if (this.currentEventType !== EditorEventType.LineBegin) {
            ...
            const t = new Line(new Point(info.pos[0], info.pos[1]), new Point(info.pos[0], info.pos[1]), { color: 'orange' });
...
export { BaseNode, BeginType, BluePrintEditor, EditorEventType, Line, MouseDownType, Node, Point };
