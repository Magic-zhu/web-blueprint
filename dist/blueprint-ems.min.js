...
class BaseNode extends Object3D {
    constructor(params) {
        super();
...
class BluePrintEditor {
    ...
    init() {
        ...
        const camera = new PerspectiveCamera(50, 1, 10, 1000);
        const renderer = new WebGLRenderer({ antialias: true });
        const cssRenderer = new CSS2DRenderer();
        const orbitControls = new OrbitControls(camera, cssRenderer.domElement);
        orbitControls.enableRotate = false;
        const transformController = new TransformControls(camera, cssRenderer.domElement);
...
export { BaseNode, BluePrintEditor };
