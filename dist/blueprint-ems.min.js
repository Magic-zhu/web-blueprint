...
class BluePrintEditor {
    ...
    reconnectBySerializationString(item, index) {
        ...
        this.graph[index].connect(connectInfo, ConnectPosition$1.BEGIN);
        this.graph[targetIndex].connect(connectInfo2, ConnectPosition$1.END);
    }
}
...
export { BaseNode, BluePrintEditor, ConnectPosition$1 as ConnectPosition, FactoryMap, Line, Node$1 as Node, NodeFactory, NodeFactoryInstance, Point };
