    ...
    restore(data) {
        ...
        arr.forEach((element, index) => {
            element.preNodeIds.forEach((item) => {
                ...
                if (condition[1] === 'node') {
                    this.graph.findIndex((item) => item.nodeId === condition[0]);
                    const connectInfo = {};
                    this.graph[index].connect(connectInfo, ConnectPosition$1.END);
                }
            });
...
export { BaseNode, BeginType, BluePrintEditor, ConnectPosition$1 as ConnectPosition, EditorEventType, FactoryMap, Line, MouseDownType, Node$1 as Node, NodeFactory, NodeFactoryInstance, Point };
